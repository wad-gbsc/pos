...
class IssuancesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $data['issuance_items'] = IssuanceDetails::leftJoin('refproduct', 'refproduct.product_id', '=', 'inv_issuance_details.product_id')
                                ->leftJoin('refunit', 'refunit.unit_id', 'refproduct.unit_id')
                                ->where('refproduct.is_deleted', 0)
