                    ...
                    <b-card > <!-- main card -->
                        <h5 slot="header">  <!-- table header -->
                            <span class="text-primary">
                                ...
                                GC type List
                                <small class="font-italic">List of all registered gc's types.</small></span>
                        </h5>
                        ...
                        <b-row> <!-- row table -->
                            <b-col sm="12">
                                ...
                                <template slot="action" slot-scope="data"> <!-- action slot  :to="{path: 'gctypes/' + data.item.id } -->
...
export default {
    ...
    methods:{
        ...
        async setDelete(data){
            if(await this.checkIfUsed('gctype', data.item.gc_type_id) == true){
                this.$notify({
                    type: 'error',
                    group: 'notification',
                    title: 'Error!',
