                    ...
                    <b-card > <!-- main card -->
                        <h5 slot="header">  <!-- table header -->
                            <span class="text-primary">
                                ...
                                Discount type List
                                <small class="font-italic">List of all registered discount types.</small></span>
                        </h5>
                        ...
                        <b-row> <!-- row table -->
                            <b-col sm="12">
                                ...
                                <b-table 
                                    responsive striped hover small bordered show-empty scroll-bar
                                ...
                                <template slot="action" slot-scope="data"> <!-- action slot  :to="{path: 'discounttypes/' + data.item.id } -->
                ...
                <b-form @keydown="resetFieldStates('discounttype')" autocomplete="off">
                    ...
                    <b-form-group>
                        ...
                        <vue-autonumeric
                            ...
                            :options="[{ minimumValue: 0 , maximumValue: 100, emptyInputBehavior:0}]">
                            ></vue-autonumeric>
                    </b-form-group>
                     <b-form-group>
                    <label>Sort</label>
...
export default {
    ...
    methods:{
        ...
        async setDelete(data){
            if(await this.checkIfUsed('discounttype', data.item.discount_type_id) == true){
                this.$notify({
                    type: 'error',
                    group: 'notification',
                    title: 'Error!',
